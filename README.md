...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17809172.svg)](https://doi.org/10.5281/zenodo.17809172)
...
- **Multi-language**: Python, IDL, Fortran, C++, MATLAB
...
Nerney, E. G. (2025). IPT Emission MOP Community Code (Version 1.0.1) [Software]. Zenodo. https://doi.org/10.5281/zenodo.17809172
...
@software{nerney_2025_ipt_emission_code,
  ...
  publisher    = {Zenodo},
  version      = {1.0.1},
  doi          = {10.5281/zenodo.17809172},
  url          = {https://doi.org/10.5281/zenodo.17809172}
}
```
