...
generate_frames_from_binary.py into an MP4 video file.
...
USAGE:
    Run this script after generate_frames_from_binary.py has completed:
        python make_movie_ffmpeg.py
...
# Movie description
MOVIE_DESCRIPTION = "Hybrid Optical+UV Stacked View (S+ 6731 A, S++ 680 A, O+ 833 A)"
...
def main():
    ...
    if n_frames > 0:
        ...
        print("Please run generate_frames_from_binary.py first.", flush=True)
        return
    ...
    print("  Top panel:    S+ 6731 A (Optical)", flush=True)
    print("  Middle panel: S++ 680 A (UV)", flush=True)
    print("  Bottom panel: O+ 833 A (UV)", flush=True)
