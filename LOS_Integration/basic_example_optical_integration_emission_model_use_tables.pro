...
PRO basic_example_optical_integration_emission_model_use_tables
  ...
  bin_width = 2.0d                         ; Angstroms (typical for R~3000 spectrograph)
  fwhm = 3.0d                              ; Angstroms (typical ground-based seeing-limited)
  ds = 0.01d                               ; Integration step size in R_J (714.92 km)
