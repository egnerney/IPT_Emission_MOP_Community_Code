...
- IPT_Emission_MOP_Community_Code/
  - LOS_Integration/Python_Code           (this script and module)
...
def main():
    ...
    This function demonstrates the complete workflow for calculating UV emission
    spectra through the Io Plasma Torus:
    
    1. Initialize the raytracer with plasma model and emission tables
    2. Calculate UV spectra for single Maxwellian distribution
    3. Calculate UV spectra for double Maxwellian distribution  
    4. Create comparison plots showing hot electron enhancement
    5. Print diagnostic information about plasma conditions
    ...
    try:
        ...
        print("    - LOS_Integration/Python_Code (containing this script)")
        print("    - Emiss_tables/CHIANTI_11.0.2_emiss_tables_single_maxwellian_50x50.h5")
        print("    - Emiss_tables/CHIANTI_11.0.2_emiss_tables_double_maxwellian_16x8x12x10.h5")
    ...
    # Test case 1: Equatorial line of sight ~aligned longitude at peak emission
    slit_pos_vec1 = np.array([20.875, -0.474, 0.0])  # Start at x=6 R_J, equator
    norm_vec1 = np.array([-0.951, 0.309190879555009, 0.0])        # Look in +y direction
    
    # Test case 2: Off-equator line of sight ~aligned longitude at peak emission
    slit_pos_vec2 = np.array([20.875, -0.474, 0.5])  # 0.5 R_J above equator
    norm_vec2 = np.array([-0.951, 0.309190879555009, 0.0])        # Look in +y direction
    ...
    if raytracer.double_maxwellian_loaded and spectrum1_double is not None:
        ...
        fig4 = raytracer.plot_spectrum(
            ...
            title="Double Maxwellian: Equatorial LOS",
            color='C1'
        )
        ...
        fig5 = raytracer.plot_spectrum(
            ...
            title="Double Maxwellian: Off-Equator LOS",
            color='C1'
        )
    ...
    print(f"  - Instrumental FWHM: {fwhm} Å")
