...
class JovianUVEmissionRaytracer:
    ...
    def _get_default_plasma_path(self):
        ...
        plasma_dir = module_dir.parent.parent / "3D_Torus_Model"
    ...
    def _get_default_emission_path_single(self):
        ...
        module_dir = Path(__file__).parent
        emiss_dir = module_dir.parent.parent / "Emiss_tables"
    ...
    def _get_default_emission_path_double(self):
        ...
        module_dir = Path(__file__).parent
        emiss_dir = module_dir.parent.parent / "Emiss_tables"
        emiss_file = emiss_dir / "CHIANTI_11.0.2_emiss_tables_double_maxwellian_16x8x12x10.h5"
    ...
    def interpolate_emission_rates_double_vectorized(self, Tec_arr, Teh_arr, ne_arr, feh_arr,
        ...
        use_single = (feh_arr < self.feh_arr[0]) | (Teh_arr < self.teh_arr[0]) | (ne_arr < self.ne_arr[0])
    ...
    def integrate_species_emission_double(self, s_values, positions, species_key,
        ...
        #print( 'Tec_los = ',Tec_los)
        #print( 'Teh_los = ',Teh_los)
        #print( 'ne_total_los = ',ne_los)
        #print( 'feh_los = ',feh_los)
